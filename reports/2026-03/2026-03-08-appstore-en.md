# SHEIN App Store Reviews - 2026-03-08
...
**Author**: Queen lavish | **Version**: 14.3.4 | **Date**: 2026-03-06

**AI Analysis**: The review expresses strong enthusiasm with 'Love it' in both the title and content, and a perfect 5/5 rating, indicating a highly favorable experience with no criticism or ambiguity.

**Topics**: Other

##### ⭐⭐⭐⭐⭐ ⭐️⭐️⭐️

> Me encanta aún que tarda en llegar

**Author**: janeth81 | **Version**: 14.3.4 | **Date**: 2026-03-06

**AI Analysis**: The reviewer expresses strong affection ('Me encanta' — 'I love it') and gives a 5-star rating, indicating overall satisfaction; the only drawback mentioned is delayed delivery, which is acknowledged but does not diminish the positive sentiment.

**Topics**: Delivery & Shipping

##### ⭐⭐⭐⭐ Las cosas llegan en estado
...
> You guys kills me on the delivery
...
> Clothes are not that good quality for a high prices, it takes a long time to get the items, they also be getting the orders wrong a lot like sometimes they won’t even send the right items, it’s terrible
...
> You keep saying it’s free shipping and when I look at the cart some items have a 3 times more then value for shipping!
...
> after having shein for years it restricted me saying i couldn’t update it .

**Author**: due to restrictions | **Version**: 14.3.4 | **Date**: 2026-03-06

**AI Analysis**: The user expresses frustration about being unable to update the SHEIN app after years of use, implying a broken or unsupported experience; the 1/5 rating reinforces strong dissatisfaction.

**Topics**: App Experience, Other

##### ⭐ Beware

> An obvious phishing scam. Requests you to provide your credit card information before you can even shop. I
...
> Everything I order am 99% satisfied with everything I get

**Author**: Scabados | **Version**: 14.3.4 | **Date**: 2026-03-06

**AI Analysis**: The reviewer gives a 5/5 rating and expresses high satisfaction ('99% satisfied with everything I get'), indicating strong positive sentiment toward their overall shopping experience.

**Topics**: Product Quality, Delivery & Shipping

##### ⭐⭐⭐⭐⭐ Fabulous

> Love their clothes. Buying for a wedding this time plenty of choice.

**Author**: patrishjm49 | **Version**: 14.3.4 | **Date**: 2026-03-06

**AI Analysis**: The reviewer uses enthusiastic language ('Fabulous', 'Love their clothes') and highlights satisfaction with product variety ('plenty of choice') for an important occasion (a wedding), indicating strong positive sentiment.

**Topics**: Product Quality, Pricing & Value, App Experience

##### ⭐⭐⭐⭐⭐ Mrs popping

> Shein is absolutely amazing in everything they sell my favourite shopping 😊

**Author**: scotlo | **Version**: 14.3.4 | **Date**: 2026-03-06

**AI Analysis**: The reviewer gives a 5/5 rating and uses strongly positive language ('absolutely amazing', 'my favourite shopping') with an emoji, indicating high satisfaction across the board.

**Topics**: Product Quality, Pricing & Value, App Experience, Other
...
> Love this app easy to use. Good value products. Trustworthy ,reliable

**Author**: M new flow | **Version**: 14.3.4 | **Date**: 2026-03-06

**AI Analysis**: The reviewer gives a 5/5 rating and uses strongly positive language such as 'Love this app', 'easy to use', 'Good value products', and 'Trustworthy, reliable', indicating high satisfaction with the app overall.

**Topics**: App Experience, Pricing & Value, Other

#### 😞 Negative Reviews (5)

##### ⭐ Should provide free delivery when spent 10 pounds or more
...
> No matter what I remove or how much the Total never goes down I had a £190 Order and I removed 11 items and the total still stayed the same I decided to remove a bit more and it still stayed the same so I wanted to check if it would do the same if I added so I added one item and my total went up as expected so it won’t go down when I remove multiple items but it goes up and only changes the total when I add items so dont know what’s going on with that…..
...
> Shown increases the prices too much. When you add the item to bag it has one price when u want to buy it it became double price which makes you very disappointed.  It doesn’t have the worth any more unfortunately
...
##### ⭐ Prices change once at checkout
